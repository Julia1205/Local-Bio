		...
		//Vérifications du formulaire
			...
			//Instanciation du model
				...
				if($verifiedMail == false){
					...
					//récupération du mot de passe correspondant à l'email dans la bdd
					$UserPassword = $objUsersModel->getUserPassword($strMailField);
					//remplissage de l'objet utilisateur avec les mots de passe
					...
					if ($verifiedPassword == true){
						//récupération des données de l'utilisateur en bdd
...
/**
*	@brief 		fonction permettant la création d'un utilisateur
* 	@details 
...
/**
*	@brief 		fonction de déconnexion
* 	@details 
*	<p>Cette fonction permet de détruire la session</p>
*
**/
...
/**
*	@brief 		fonction de modification du profil
* 	@details 
*	<p>Cette fonction permet de modifier les données d'un utilisateur dans la base de données</p>
*
**/
