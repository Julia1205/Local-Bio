...
/**
*	@brief 		méthode retournant la liste des produits de la base de données en fonction de la catégorie si précisée
* 	@details 
*	<p>Cette méthode permet de rechercher via une requête, 
*		la liste des produits présents dans la base de données et contient également une barre de recherche ciblant le nom et la description des produits</p>
...
**/
		public function boutique($intCat=null){
			...
			/*Réalisation de la barre de recherche*/
...
/**
*	@brief 		méthode retournant les détails du produit de la base de données en fonction de son nom
* 	@details 
*	<p>Cette méthode permet de rechercher via une requête, 
