            ...
            <div class="MemberCarteBox">
                <div class="col-lg-offset-3 col-lg-2 MemberCarte">
                    <div class="CerclePhoto">
                        <?php echo img(array('src'=>'images/author6-176x176.png', 'alt'=> 'Etienne', 'class'=> 'ProfilePhoto')); ?>
                    </div>
                ...
                <div class="col-lg-2 MemberCarte">
                    <div class="col-lg-offset-3 col-lg-2 MemberCarte">
                        <div class="CerclePhoto">
                            <?php echo img(array('src'=>'images/author2-176x176.png', 'alt'=> 'Léo', 'class'=> 'ProfilePhoto')); ?>
                        </div>
                        <div class="FeuilleEtPrénom">
                            <div class="BoxPrénom">
                ...
                <div class="col-lg-2 MemberCarte">
                    <div class="col-lg-offset-3 col-lg-2 MemberCarte">
                        <div class="CerclePhoto">
                            <?php echo img(array('src'=>'images/author3-176x176.png', 'alt'=> 'Lola', 'class'=> 'ProfilePhoto')); ?>
                        </div>
                        <div class="FeuilleEtPrénom">
                            <div class="BoxPrénom">
